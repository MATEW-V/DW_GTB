            ...
            <main className="submit-wrapper">
                <section className="submit-part-card">
                    ...
                    <div className="submit-info-box">
                        ...
                        <p className="submit-description">Requirements:</p>
                        <ul className="submit-description">
                            <li>minimum 50 second clip</li>
                            <li>win chime match (enough info and not footage of being beat up)</li>
                            <li>builder link</li>
                        </ul>
                    </div>
